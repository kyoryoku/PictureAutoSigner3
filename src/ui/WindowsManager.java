...
public class WindowsManager {
    ...
    public void openMainWindow(){
        if (!openedWindows.contains("mainViewStage")){
            try {
                ...
                mainViewStage.setOnCloseRequest(e -> {
                    closeMainWindow();
                });
    ...
    public void openCommandWindow(){
        if (!openedWindows.contains("commandViewStage")){
            try {
                ...
                commandViewStage.setOnCloseRequest(e -> {
                    closeCommandWindow();
                });
    ...
    public void openHelpWindow(){
        if(!openedWindows.contains("helpViewStage")){
            try {
                ...
                helpViewStage.setOnCloseRequest(e -> {
                    closeHelpWindow();
                });
    ...
    public void openProfileWindow(){
        if (!openedWindows.contains("profileViewStage")){
            try {
                ...
                profileViewStage.setOnCloseRequest(e -> {
                    closeProfileWindow();
                });
    ...
    public void openAssignKeyWindow(){
        if (!openedWindows.contains("assignKeyViewStage")){
            try {
                Parent root = FXMLLoader.load(getClass().getResource("assignKeyView.fxml"));
                ...
                assignKeyViewStage.setOnCloseRequest(e -> {
